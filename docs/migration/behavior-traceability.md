...
| B-010 Defeat | Player Health reaching zero transitions Arena Run to Defeat. Defeat is terminal and further combat progression is rejected. | INV-012, INV-013, INV-061, INV-062, INV-063, INV-064, INV-160, INV-161, INV-162 | `PlayerDefeatChangesGamePhase` | LEG-009 | `LethalPlayerDamageDefeatsRun`, `DefeatedRunRejectsFurtherCombatProgression` |
