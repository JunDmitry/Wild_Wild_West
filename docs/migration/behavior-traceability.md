...
| B-006 Melee attack | A ready Melee Attack uses the Player position after resolved movement, affects each valid Enemy at most once, and advances melee readiness. | INV-020, INV-024, INV-100, INV-101, INV-102, INV-104, INV-062, INV-063, INV-064, INV-065 | — | LEG-006, LEG-019, LEG-022 | `MeleeAttackUsesResolvedPlayerPosition`, `MeleeAttackDamagesEachEnemyOnce` |
